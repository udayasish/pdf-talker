      ...
      <div className="max-w-md w-full mx-auto p-8 relative z-10">
        ...
        >
          ...
          <p className="text-neutral-500 text-sm text-center mb-8">
            Sign in to continue to PDF Talker
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-neutral-700 bg-neutral-800/50 text-purple-500 focus:ring-purple-500/50 focus:ring-offset-neutral-900"
                />
